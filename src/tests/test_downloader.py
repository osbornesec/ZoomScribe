...
def recording_factory() -> RecordingFactory:
    """Return a Recording factory that yields deterministic test data for unit tests."""

    def _factory(uuid: str) -> Recording:
        """Build a predictable Recording instance whose fields embed the provided UUID."""
